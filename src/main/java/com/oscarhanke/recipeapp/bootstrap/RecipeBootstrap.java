package com.oscarhanke.recipeapp.bootstrap;

import com.oscarhanke.recipeapp.domain.Category;
import com.oscarhanke.recipeapp.domain.Difficulty;
import com.oscarhanke.recipeapp.domain.Ingredient;
import com.oscarhanke.recipeapp.domain.Notes;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        guacamoleRecipe.setDirections("1. Cut the avocados in half. Remove the pit. Score the inside of the avocado with a blunt knife and scoop out the flesh with a spoon. Place in a bowl." +
                "\n" +
        ...
        guacamoleNotes.setRecipeNotes("Look for ancho chile powder with the Mexican ingredients at your grocery store, on buy it online. (If you can't find ancho chili powder, you replace the ancho chili, the oregano, and the cumin with 2 1/2 tablespoons regular chili powder, though the flavor won't be quite the same.)");
        ...
        guacamoleRecipe.setSource("Simply Recipe");
